...
namespace DevCamp.WebApp.Controllers
{
    public class IncidentController : Controller
    {
        ...
        [Authorize]
        [HttpPost]
        public async System.Threading.Tasks.Task<ActionResult> Create([Bind(Include = "City,Created,Description,FirstName,ImageUri,IsEmergency,LastModified,LastName,OutageType,PhoneNumber,Resolved,State,Street,ZipCode")] IncidentViewModel incident, HttpPostedFileBase imageFile)
        {
            try
            {
